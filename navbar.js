document.addEventListener("DOMContentLoaded", () => {
    ...
    function initNavbar() {
        ...
        const signInLinksDesktop = `
            <a href="employer/signin-emp.html"  hover:text-violet-600">Sign in as Employee</a>
            <a href="job_seeker/signin-job.html" class="ml-4  hover:text-violet-600">Sign in as Job Seeker</a>
        `;
